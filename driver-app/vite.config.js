...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    base: './',
    define: {
      'import.meta.env.VITE_APP_ROLE': JSON.stringify('driver'),
    },
    plugins: [
      react(),
      VitePWA({
        ...
        manifest: {
          name: 'RideEasy Driver',
          short_name: 'RideEasy Driver',
          description: 'Driver app — accept rides in Pune & Kolhapur with RideEasy.',
          start_url: '/',
          scope: '/',
          display: 'standalone',
