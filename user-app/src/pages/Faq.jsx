  ...
  return (
    <div className="min-h-dvh min-h-screen w-full overflow-x-hidden bg-black text-white pb-24">
      <header className="sticky top-0 z-10 flex items-center gap-2 border-b border-zinc-800 bg-black/90 px-3 py-3 backdrop-blur sm:gap-3 sm:px-4">
        ...
        <h1 className="min-w-0 flex-1 truncate text-base font-semibold sm:text-lg">Frequently Asked Questions</h1>
      </header>
      ...
      <div className="mx-auto w-full max-w-lg space-y-4 px-3 pt-4 sm:px-4">
        {CATEGORY_IDS.map((id) => {
          ...
          return (
            <section key={id} className="rounded-2xl border border-brand-border bg-brand-card p-4">
        ...
        <p className="pb-2 text-center text-xs text-zinc-500">
          Still need help? Visit Help &amp; Support.
        </p>
      </div>
    </div>
  )
