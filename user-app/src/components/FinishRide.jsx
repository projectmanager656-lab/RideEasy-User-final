...
const FinishRide = (props) => {
    ...
    async function endRide() {
        try {
            ...
            alert(err.response?.data?.message || t('could_not_complete_ride'))
        }
    ...
    return (
        <div>
            ...
            <h3 className='text-2xl font-semibold mb-5 text-theme-primary'>{t('finish_this_ride')}</h3>
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                <div className='mt-10 w-full'>
                    ...
                    <button
                        onClick={endRide}
                        className='w-full mt-5 flex  text-lg justify-center bg-green-600 text-white font-semibold p-3 rounded-lg'>{t('finish_ride')}</button>
