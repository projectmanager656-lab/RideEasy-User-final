...
import { en as chatEn, hi as chatHi, mr as chatMr } from './chat'

export const en = { ...baseEn, ...homeEn, ...bookEn, ...searchEn, ...ridingEn, ...profileEn, ...supportEn, ...chatEn }
export const hi = { ...baseHi, ...homeHi, ...bookHi, ...searchHi, ...ridingHi, ...profileHi, ...supportHi, ...chatHi }
export const mr = { ...baseMr, ...homeMr, ...bookMr, ...searchMr, ...ridingMr, ...profileMr, ...supportMr, ...chatMr }
